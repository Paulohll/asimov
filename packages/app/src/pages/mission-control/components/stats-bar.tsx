...
export function StatsBar() {
  ...
  const items = createMemo(() => [
    { label: "busy", color: "text-icon-success-base", dot: "bg-icon-success-base", count: counts().busy },
    { label: "idle", color: "text-text-weak", dot: "bg-border-base-base", count: counts().idle },
    { label: "retry", color: "text-icon-critical-base", dot: "bg-icon-critical-base", count: counts().retry },
  ])
